...
starting_row = 2 #65 is python unicode for 'A'
for row in rows[1:6]:
    td = row.findAll('td')
    rank = td[0].text
    ...
    write_sheet['A' + str(starting_row)] = rank
    write_sheet['B' + str(starting_row)] = movie_title
    write_sheet['C' + str(starting_row)] = release
    write_sheet['D' + str(starting_row)] = theaters
    write_sheet['E' + str(starting_row)] = gross
    write_sheet['F' + str(starting_row)] = average_gross
    starting_row += 1
